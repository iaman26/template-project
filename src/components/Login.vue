<template>
  <div class="flex">
    <img src="/src/assets/images/banner-login.png" class="w-2/3" alt="" />
    <div class="dark:bg-gray-900 w-full">
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="mt-4" action="#">
              ...
              <div class="flex items-center w-full mt-5 justify-between">
                <button
                  class="py-2 border flex gap-2 border-slate-200 h-10 px-3 dark:border-slate-700 rounded-lg text-slate-700 dark:text-slate-200 hover:border-slate-400 dark:hover:border-slate-500 hover:text-slate-900 dark:hover:text-slate-300 hover:shadow transition duration-150"
                >
                  <img
                    class="ml-4 w-4 h-4"
